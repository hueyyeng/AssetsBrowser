...
class Ui_AssetDialog(object):
    def setupUi(self, AssetDialog):
        ...
        AssetDialog.setMinimumSize(QtCore.QSize(320, 370))
        AssetDialog.setMaximumSize(QtCore.QSize(320, 370))
        ...
        self.previewGroup.setGeometry(QtCore.QRect(10, 240, 291, 81))
        ...
        self.previewText.setGeometry(QtCore.QRect(10, 20, 271, 51))
        ...
        self.btnCreate.setGeometry(QtCore.QRect(141, 331, 75, 23))
        self.btnCreate.setObjectName(_fromUtf8("btnCreate"))
        self.btnCancel = QtGui.QPushButton(AssetDialog)
        self.btnCancel.setGeometry(QtCore.QRect(222, 331, 75, 23))
        ...
        self.catVehicles.raise_()
        self.catCH.raise_()
        self.catFX.raise_()
        self.catProps.raise_()
        self.catBG.raise_()
